...
<!--
    ...
    el nombre de los equipos de la primera división de la liga de fútbol. 
    Cada equipo contendrá un array de dos elementos, 
    el primero, con clave “puntos” contiene la puntuación obtenida en la pasada liga. 
    El segundo elemento con clave “posición” contendrá en número la posición en la tabla en la que finalizó el equipo la liga.
    Utilizando los bucles que necesites muestra en pantalla los nombres de los equipos, 
    los puntos y la posición de los equipos que terminaron en las tres primeras posiciones de la liga.
-->
    ...
    <?php
        ...
        echo "<table>";
            echo "<tr>";
                ...
                echo "<th>Puntos</th>";
            echo "</tr>";
        foreach(array_slice($equipos, 0, 3) as $clave => $valor) {
            echo "<tr>";
                echo "<td>" . $valor["posicion"] . "</td>";
                echo "<td>" . $clave . "</td>";
                echo "<td>" . $valor["puntos"] . "</td>";
            echo "</tr>";
        } 
        echo "</table>";
    ?>
